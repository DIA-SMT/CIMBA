...
const DESCRIPCIONES: Record<TipoProblema, string[]> = {
  ...
  perdida_agua: ["Pérdida de agua que socava el pavimento", "Caño roto sobre la calzada"],
  perdida_cloacal: ["Desborde cloacal sobre la calle", "Pérdida de líquidos cloacales junto al cordón"],
